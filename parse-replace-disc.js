...
const content = fs.readFileSync('src/pages/DiscussionPage.tsx', 'utf8');
...
fs.writeFileSync('src/pages/DiscussionPage.tsx', newContent, 'utf8');
console.log('DiscussionPage updated!');
